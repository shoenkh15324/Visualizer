...
static uint32_t i2s_sample_rate = 441000;
...
__weak void HAL_I2S_MspDeInit(I2S_HandleTypeDef* i2sHandle)
{
...
#define BLOCK_X_CNT		32
#define BLOCK_Y_CNT		32
